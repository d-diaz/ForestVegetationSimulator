...
C
      ...
      INTEGER IFSP,IREGN,IRDUM,INUM,IDFLG,IDTYPE,IXF,IXTMP,JJTAB
      REAL CAPHT,CAPFLG,CAPPRP,CAPDBH,DUM1,XTMP,X,XXG
...
C
        CASE ('SN')
          IF ( LNOTBK(2) .AND. .NOT. LNOTBK(8) ) THEN
            KARD(2) = ADJUSTL(KARD(2))
            ECOREG = KARD(2)(:4)
          END IF

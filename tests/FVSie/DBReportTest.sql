...
SELECT * FROM pragma_table_info('FVS_ATRTList');
...
SELECT * FROM pragma_table_info('FVS_BurnReport');
...
SELECT * FROM pragma_table_info('FVS_CalibStats');
...
SELECT * FROM pragma_table_info('FVS_CanProfile');
...
SELECT * FROM pragma_table_info('FVS_Carbon');
...
SELECT * FROM pragma_table_info('FVS_CutList');
...
SELECT * FROM pragma_table_info('FVS_DM_Spp_Sum');
...
SELECT * FROM pragma_table_info('FVS_DM_Stnd_Sum');
...
SELECT * FROM pragma_table_info('FVS_Down_Wood_Cov');
...
SELECT * FROM pragma_table_info('FVS_Down_Wood_Vol');
...
SELECT * FROM pragma_table_info('FVS_EconHarvestValue');

select 'Table: FVS_EconSummary' as '';
SELECT * FROM pragma_table_info('FVS_EconSummary');
...
SELECT * FROM pragma_table_info('FVS_Fuels');
...
SELECT * FROM pragma_table_info('FVS_Hrv_Carbon');
...
SELECT * FROM pragma_table_info('FVS_Mortality');
...
SELECT * FROM pragma_table_info('FVS_PotFire');
...
SELECT * FROM pragma_table_info('FVS_Regen_HabType');
...
SELECT * FROM pragma_table_info('FVS_Regen_Ingrow');
...
SELECT * FROM pragma_table_info('FVS_Regen_SitePrep');
...
SELECT * FROM pragma_table_info('FVS_Regen_Sprouts');
...
SELECT * FROM pragma_table_info('FVS_Regen_Tally');
...
SELECT * FROM pragma_table_info('FVS_SnagDet');
...
SELECT * FROM pragma_table_info('FVS_SnagSum');
...
SELECT * FROM pragma_table_info('FVS_Stats_Species');
...
SELECT * FROM pragma_table_info('FVS_Stats_Stand');
...
SELECT * FROM pragma_table_info('FVS_StrClass');
...
SELECT * FROM pragma_table_info('FVS_Summary2');
...
SELECT * FROM pragma_table_info('FVS_TreeList');
